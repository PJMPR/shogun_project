...
$ASSETS_S   = "$PROJECT\frontend\public\assets\syllabusy"
$ASSETS_N   = "$PROJECT\frontend\public\assets\syllabusy-n"
$OUTPUT_S   = "$PROJECT\frontend\public\assets\files\stacjonarne"
$OUTPUT_N   = "$PROJECT\frontend\public\assets\files\niestacjonarne"
