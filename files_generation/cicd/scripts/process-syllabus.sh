...
JSON_ASSET_FULL="$REPO_ROOT/frontend/public/${JSON_ASSET_PATH}"
PDF_ASSET_DIR_FULL="$REPO_ROOT/frontend/public/${PDF_ASSETS_REL}"
...
LATEX_DIR="$REPO_ROOT/files_generation/latex"
TEMP_DIR=$(mktemp -d)
