 ...
 *  – wersja: STARY program stacjonarny (public/assets/stary/stac)
 */
...
const BASE  = `${__dir}/../../../frontend/public/assets/stary/stac`;
...
writeFileSync(`${__dir}/program_stacjonarny_stary.tex`, texS, 'utf8');

process.stdout.write('OK: program_stacjonarny_stary.tex\n');
