...
# ---------------------------------------------------------------------------
BASE_DIR = Path(__file__).parent.parent  # katalog projektu (pj-studies)

INPUT_OUTPUT_MAP = {
    BASE_DIR / 'public' / 'assets' / 'syllabusy': BASE_DIR / 'public' / 'assets' / 'files' / 'stacjonarne',
    BASE_DIR / 'public' / 'assets' / 'syllabusy-n': BASE_DIR / 'public' / 'assets' / 'files' / 'niestacjonarne',
}
