...
\begin{tabularx}{\textwidth}{lX}
  ...
  \hline
  Machine Learning (IML) & Znajomosc budowy podstawowych architektur sztucznych sieci neuronowych, funkcji aktywacji, architektur splotowych i rekurencyjnych, algorytmow uczenia maszynowego (k-means, SVM, drzewo decyzyjne, las losowy, klasyfikator Bayesowski) \\
  \hline
\end{tabularx}
