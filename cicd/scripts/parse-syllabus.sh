...
if echo "$TRYB" | grep -qi "niestacjonar"; then
  SYLLABUS_MODE="n"
  SYLLABUS_JSON_DIR="public/assets/syllabusy-n"
  SYLLABUS_PDF_DIR="public/assets/files/niestacjonarne"
else
  SYLLABUS_MODE="s"
  SYLLABUS_JSON_DIR="public/assets/syllabusy"
  SYLLABUS_PDF_DIR="public/assets/files/stacjonarne"
fi
