...
\endhead
  ...
  \hline
  Bezpieczeństwo protokołów i urządzeń warstwy 1-2 modelu OSI & & \\
  \hline
  Bezpieczeństwo protokołów i urządzeń warstwy 3-4 modelu OSI & & \\
  \hline
  Bezpieczeństwo protokołów i urządzeń warstwy 5-7 modelu OSI & & \\
  \hline
  Metody analizy ruchu sieciowego (Network analysis) & & \\
  \hline
  Metody analizy oprogramowania (Software analysis) & & \\
  \hline
  Metody analizy mediów (Media analysis) & & \\
  \hline
  Metody analizy sprzętu (Hardware analysis) & & \\
  \hline
  Ćwiczenia: & & \\
  \hline
