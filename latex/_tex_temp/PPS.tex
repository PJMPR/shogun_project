...
\endhead
  \hline
  Programowanie platform cyfrowych i peryferiów & & \\
  \hline
  Arduino: Arduion IDE + gcc-avr & & \\
  \hline
  Raspberry Pi: C++, Python, NodeJS (2 do wyboru) & & \\
  \hline
  MSP 430 & & \\
  \hline
  PLC & & \\
  \hline
  Weryfikacja wybranych algorytmów dla potrzeb IoT w środowisku Ptolemy & & \\
  \hline
  Atiny & & \\
  \hline
\end{longtable}
