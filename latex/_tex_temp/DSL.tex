...
\endhead
  \hline
  Wprowadzenie do baz słownikowych i ich zastosowań & & \\
  \hline
  Model klucz–wartość i jego charakterystyka & & \\
  \hline
  Porównanie baz słownikowych z innymi modelami baz danych & & \\
  \hline
  Podstawowe operacje zapisu i odczytu danych & & \\
  \hline
  Struktury danych w bazach słownikowych & & \\
  \hline
  Spójność danych i modele replikacji & & \\
  \hline
  Wydajność i skalowalność baz klucz–wartość & & \\
  \hline
  Zastosowanie baz słownikowych jako cache & & \\
  \hline
  Integracja bazy słownikowej z aplikacją & & \\
  \hline
