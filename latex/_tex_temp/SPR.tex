...
\endhead
  \hline
  Pojęcie szybkiego portotypowania, podstawowe narzędzia i techniki & & \\
  \hline
  Projektowanie obiektów do druku 3D z wykorzystaniem narzędzia Tinkercad & & \\
  \hline
  Projektowanie obiektów do druku 3D z wykorzystaniem narzędzia Blender & & \\
  \hline
  Przygotowanie projektu do druku 3D & & \\
  \hline
  Właściwości wydrukowanego elementu – wpływ orientacji drukowanego elementu na jego właściwości fizyczne & & \\
  \hline
  Omówienie różnych technik druku 3d – SLA, SLS, FDM & & \\
  \hline
  Omówienie różnych popularnych materiałów do druku 3D & & \\
  \hline
  Praktyczna umiejętność wymiarowania obiektów & & \\
  \hline
  Praktyczna realizacja projektu w oparciu o prototypy & & \\
  \hline
\end{longtable}
