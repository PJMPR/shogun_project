...
\vspace{4pt}
\noindent\textbf{Zadania do samodzielnej realizacji:} Samodzielna praca nad projektami prototypowania; implementacja prototypów z użyciem wybranych technologii; przygotowanie prezentacji i obrony projektu.
...
\textit{Introduction to the basic techniques of rapid prototyping.}
...
\endhead
  \hline
  1. & Pojęcie szybkiego portotypowania, podstawowe narzędzia i techniki &  \\
  \hline
  2. & Projektowanie obiektów do druku 3D z wykorzystaniem narzędzia Tinkercad &  \\
  \hline
  3. & Projektowanie obiektów do druku 3D z wykorzystaniem narzędzia Blender &  \\
  \hline
  4. & Przygotowanie projektu do druku 3D &  \\
  \hline
  5. & Właściwości wydrukowanego elementu – wpływ orientacji drukowanego elementu na jego właściwości fizyczne &  \\
  \hline
  6. & Omówienie różnych technik druku 3d – SLA, SLS, FDM &  \\
  \hline
  7. & Omówienie różnych popularnych materiałów do druku 3D &  \\
  \hline
  8. & Praktyczna umiejętność wymiarowania obiektów &  \\
  \hline
  9. & Praktyczna realizacja projektu w oparciu o prototypy &  \\
  \hline
\end{longtable}
