...
\vspace{4pt}
\noindent\textbf{Zadania do samodzielnej realizacji:} Projektowanie i implementacja projektu programistycznego z nowoczesnych technologii API; przygotowanie prezentacji i dokumentacji projektu; przygotowanie do egzaminu.
...
\textit{The course 'Trends in API Development' aims to familiarize students with current directions of development and innovations in the field of creating APIs for web applications. Students acquire theoretical and practical knowledge of the latest standards, protocols, and tools used for designing, implementing, and managing APIs. Participants have the opportunity to explore issues such as API security, scalability, performance, and good programming practices. They also become familiar with different API styles, including REST, GraphQL, gRPC, and others, analyzing their advantages, disadvantages, and applications in various project contexts. Another important element of the course is group work, which aims to develop collaboration, communication, and innovative thinking skills. Students are tasked with analyzing and preparing material on a selected API-related technology, allowing them to deepen their knowledge and practical skills in a specific area.}
...
\endhead
  \hline
  1. & Wprowadzenie do API (Application Programming Interface). Przegląd różnych typów API (REST, SOAP, GraphQL, gRPC, itd.). Znaczenie i role API w rozwoju aplikacji internetowych &  \\
  \hline
  2. & Konwencje, normy i najlepsze praktyki w tworzeniu REST API &  \\
  \hline
  3. & GraphQL - wprowadzenie i porównanie z REST. Tworzenie prostych API z wykorzystaniem GraphQL &  \\
  \hline
  4. & Wprowadzenie do gRPC. Porównanie gRPC z REST i GraphQL, zalety i wady &  \\
  \hline
  5. & Rola i znaczenie dokumentacji API. Narzędzia do tworzenia dokumentacji API - OpenAPI, Swagger, Postman &  \\
  \hline
  6. & Język TypeScript &  \\
  \hline
  7. & Inne znane technologie wspierające proces budowania aplikacji internetowych. &  \\
  \hline
\end{longtable}
