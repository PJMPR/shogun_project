...
\hline
16 h & --- & 16 h & 32 h & 93 h & 125 h & \textbf{3} \\
\hline
\end{tabular}
\end{center}
...
\endhead
  ...
  \hline
  1. Wprowadzenie, zasady zaliczenia przedmiotu. Założenia prac projektowych, ich prowadzenia i dokumentowania. Zapoznanie się z dostępnym środowiskiem. Dyskusja nad sformułowaniami projektów i grup projektowych. Opis projektu, założenia projektowe Analiza dokumentacji przykładowych rozwiązań projektowych. & & \\
  \hline
  2. Praca nad projektem: Identyfikacja problemu. Kontekst i udziałowcy problemu; klient projektu. Wzbogacony wizerunek, definicja i wizja systemu, zakres systemu, rodzaj produktu. Przygotowanie Dokumentu Założeń Wstępnych & & \\
  \hline
  3. Specyfikacja wymagań na system, podział i analiza wymagań. User stories. Studium wykonalności projektu; analiza organizacyjna, mikro i makrootoczenie projektu; dyskusja wariantów rozwiązania. Dobór strategii realizacji projektu w zależności od rodzaju produktu. Debata & & \\
  \hline
  4. Modelowanie systemu (przypadki użycia, diagramy sekwencji i/lub czynności). Logiczny diagram klas & & \\
  \hline
  5. Modelowanie systemu. Architektura systemu: podział na podsystemy i komponenty. Projekt bazy danych. & & \\
  \hline
  6. Harmonogram prac implementacyjnych, integracji, testowania oraz dodatkowej dokumentacji z podziałem na członków zespołu i ich role. & & \\
  \hline
  7. Konfiguracja środowiska programistycznego i technologicznego. & & \\
  \hline
  8. Prace implementacyjne. Realizacja zadań projektowych wg. Harmonogramu. & & \\
  \hline
  9. Prace implementacyjne. Realizacja zadań projektowych wg. Harmonogramu. & & \\
  \hline
  10. Prace implementacyjne. Wstępna ocena postępów, analiza zagrożeń. & & \\
  \hline
  11. Implementacja i integracja oprogramowania. & & \\
  \hline
  12. Implementacja i integracja. Inspekcja kodu. Analiza bezpieczeństwa. & & \\
  \hline
  13. Ocena i poprawa jakości oprogramowania. Scenariusze testów. Testowanie i walidacja oprogramowania; przygotowanie raportu z przeprowadzonych testów. & & \\
  \hline
  14. Finalizacja prac implementacyjnych i dokumentacyjnych; odbiór techniczny, przygotowanie raportu końcowego. & & \\
  \hline
  15. Prezentacja, omówienie i podsumowanie projektów. Zaliczenie przedmiotu. & & \\
  \hline
\end{longtable}
