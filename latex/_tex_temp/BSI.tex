...
\endhead
  \hline
  K\_W23 & Student zna i rozumie zaawansowane pojęcia z zakresu cyberbezpieczeństwa: kryptografię symetryczną i asymetryczną, protokoły bezpieczeństwa (TLS/SSL, Kerberos, PKI), bezpieczeństwo sieci i systemów operacyjnych. [K\_W23] & kolokwium \\
  \hline
  K\_W23 & Student zna i rozumie metody oceny podatności systemów informatycznych, typologię ataków (OWASP Top 10, MITRE ATT\&CK) i zasady bezpiecznego wytwarzania oprogramowania (SAST, DAST, DevSecOps). [K\_W23] & kolokwium \\
  \hline
  K\_W08 & Student zna i rozumie zaawansowane zagadnienia sieci komputerowych w kontekście bezpieczeństwa: firewalle, systemy IDS/IPS, VPN, segmentację sieci i zasady zero-trust. [K\_W08] & kolokwium \\
  \hline
\end{longtable}
...
\endhead
  \hline
  K\_U30 & Student potrafi zdiagnozować problem cyberbezpieczeństwa, zaprojektować i wdrożyć rozwiązanie ochrony systemu informatycznego, przeprowadzić testy penetracyjne i analizę podatności. [K\_U30] & ocena pracy podczas ćwiczenia, raport z wykonanego zadania \\
  \hline
  K\_U14 & Student potrafi skonfigurować mechanizmy kontroli dostępu, szyfrowania danych i monitorowania bezpieczeństwa w systemach informatycznych. [K\_U14] & ocena pracy podczas ćwiczenia, raport z wykonanego zadania \\
  \hline
\end{longtable}
...
\endhead
  \hline
  K\_K06 & Student jest gotów do odpowiedzialnego projektowania bezpiecznych systemów informatycznych z uwzględnieniem etycznych aspektów ochrony danych i prywatności użytkowników. [K\_K06] & ocena pracy podczas ćwiczenia, raport z wykonanego zadania \\
  \hline
  K\_K03 & Student jest gotów do samodzielnego poszerzania wiedzy o nowych zagrożeniach i technikach obrony w dynamicznie zmieniającym się krajobrazie cyberbezpieczeństwa. [K\_K03] & ocena pracy podczas ćwiczenia, raport z wykonanego zadania \\
  \hline
\end{longtable}
