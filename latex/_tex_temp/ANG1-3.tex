...
\endhead
  \hline
   & Student potrafi pozyskiwać informacje z różnych źródeł bez naruszania praw autorskich. & kolokwium, egzamin ustny, ocena sporządzonego dokumentu \\
  \hline
   & Student potrafi zrozumieć, przeanalizować i tłumaczyć teksty techniczne w języku angielskim. & kolokwium, egzamin ustny, ocena sporządzonego dokumentu \\
  \hline
   & Student potrafi posługiwać się językiem formalnym. & kolokwium, egzamin ustny, ocena sporządzonego dokumentu \\
  \hline
   & Student potrafi poprawnie komunikować się w języku angielskim w środowisku akademickim i zawodowym używając fachowego słownictwa korzystając z narzędzi telekomunikacyjnych i prezentacji multimedialnych. & kolokwium, egzamin ustny, ocena sporządzonego dokumentu \\
  \hline
   & Student potrafi komunikować się w języku angielskim w życiu codziennym. & kolokwium, egzamin ustny, ocena sporządzonego dokumentu \\
  \hline
