...
\endhead
  ...
  liczby wymierne, & & \\
  \hline
  działania wykonywane na liczbach, & & \\
  \hline
  notacja pozycyjna, & & \\
  \hline
  figury geometryczne, & & \\
  ...
  typy danych, & & \\
  \hline
  tryb całkowitoliczbowy, & & \\
  \hline
  tryb zmiennoprzecinkowy, & & \\
  \hline
  tekstowe typy danych etc. & & \\
  \hline
  2.Zagadnienia biznesowe (w zależności od poziomu zaawansowania grupy) np. & & \\
  \hline
  debatowanie, & & \\
  \hline
  wywieranie wpływu, & & \\
  ...
  team building, & & \\
  \hline
  style zarządzania,  rynki międzynarodowe etc. & & \\
  \hline
  3. Teksty specjalistyczne o tematyce związanej z informatyką, technologią.  Pogłębianie umiejętności czytania ze zrozumieniem tekstów bazujących na oryginalnych materiałach źródłowych. & & \\
  \hline
  4. Zagadnienia z zakresu informatyki (w zależności od poziomu zaawansowania grupy np). & & \\
  \hline
  ...
  wirusy komputerowe, & & \\
  \hline
  gry komputerowe, sieci komputerowe, & & \\
  \hline
  nowe technologie, & & \\
  \hline
  języki programowania, & & \\
  \hline
  oprogramowanie komputerowe etc.) & & \\
  \hline
  5. Pogłębianie znajomości podstawowych oraz specjalistycznych wyrażeń i zwrotów z zakresu języka technicznego, akademickiego i świata pracy. & & \\
  \hline
  6.Ćwiczenie złożonych struktur leksykalnych, omówienie właściwości fizycznych materii, kształtów, wprowadzenie terminologii matematycznej, interpretacja rysunków, diagramów, opis procesu. Wprowadzenie słownictwa specjalistycznego z dziedziny informatyki. & & \\
  \hline
  7.Realizowanie gramatyki w zakresie wymaganym dla danego poziomu znajomości języka. Nauczanie struktur niezbędnych do komunikacji werbalnej i pisemnej w środowisku akademickim i świata pracy. & & \\
  \hline
  8.Pisanie różnorodnych tekstów, niezbędnych w pracy i na uczelni, np.: raportu, życiorysu zawodowego, wiadomości email, streszczenia, notatki, abstraktu, instrukcji, objaśnienia procesu. & & \\
  \hline
  9. Słuchanie w oparciu o materiały przedstawiające sytuacje związane ze & & \\
  \hline
  ...
  \hline
  10. Komunikacja w świecie pracy i społeczności akademickiej, np: prezentacje, rozmowa kwalifikacyjna, rozmowy formalne i nieformalne, negocjacje, przedstawianie argumentów, rozwiązywanie problemów, case studies, prowadzenie spotkań formalnych, itp. Ćwiczenie wymowy i prawidłowego akcentowania wyrazów. & & \\
  \hline
  11. Analiza i rozumienie języka specjalistycznego oraz tłumaczenie krótkich tekstów technicznych. K\_U01 & & \\
  \hline
  12. Nauka prezentowania w języku angielskim, w tym używania adekwatnych konstrukcji językowych i odpowiedniego słownictwa, analiza technik prezentowania, zapoznanie się z prawidłową strukturą prezentacji i odpowiednim włączaniem materiałów wizualnych, przygotowanie kilkuminutowej prezentacji o tematyce związanej z kierunkiem studiów, wybraną specjalizacją i zainteresowaniami.( & & \\
  \hline
  13. Ćwiczenie umiejętności językowych (mówienie, słuchania, pisania i czytania oraz wzbogacanie słownictwa i gramatyki pod kątem przygotowania studentów do egzaminów międzynarodowych Cambridge ESOL (BEC, FCE, CAE, CPE, IELTS) oraz TOEIC Reading\&Listening. & & \\
  \hline
  14. Wypowiedzi ustne studentów (prezentacje multimedialne, artykuły prasowe,  prezentacje projektów etc.) & & \\
  \hline
  15. Colloquium / Podsumowanie semestru. & & \\
  \hline
\end{longtable}
