...
\vspace{4pt}
\noindent\textbf{Zadania do samodzielnej realizacji:} Implementacja systemów reprezentacji wiedzy (ontologie, reguły logiczne); rozwiązywanie zadań programistycznych z zakresu KR; przygotowanie raportów z wykonanych zadań.
...
\textit{The aim of the course is to familiarize students with various forms of knowledge representation and inference systems that can be used by IT systems for problem solving.}
...
\endhead
  \hline
  1. & Podstawy głębokich sieci neuronowych &  \\
  \hline
  2. & Praktyczne zapoznanie się z biblioteką TensorFlow jako przykład narzedzia wspomagającego tworzenie głębokich sieci neuronowych &  \\
  \hline
  3. & Dopasowanie reprezentacji danych dla DNN i ich wykorzystanie w celu utworzenia modeli predykcyjnych &  \\
  \hline
\end{longtable}
