...
\endhead
  ...
  \hline
  Praktyczne zapoznanie się z biblioteką TensorFlow jako przykład narzedzia wspomagającego tworzenie głębokich sieci neuronowych & & \\
  \hline
  Dopasowanie reprezentacji danych dla DNN i ich wykorzystanie w celu utworzenia modeli predykcyjnych & & \\
  \hline
\end{longtable}
