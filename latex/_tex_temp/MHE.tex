...
\vspace{4pt}
\noindent\textbf{Zadania do samodzielnej realizacji:} Implementacja zadań z metaheurystyk w C++ (algorytmy ewolucyjne, symulowane wyżarzanie itp.); prowadzenie repozytorium git; obrona kolejnych zadań zaliczeniowych.
...
\endhead
  ...
  \hline
  2. & Zagadnienia optymalizacyjne &  \\
  \hline
  3. & Metoda dokładna &  \\
  \hline
  4. & Algorytm losowego próbkowania &  \\
  \hline
  5. & Algorytm wspinaczkowy &  \\
  \hline
  6. & Algorytm Tabu &  \\
  \hline
  ...
  \hline
  9. & Metody zrównoleglania obliczeń dla Algorytmu Genetycznego &  \\
  \hline
  10. & Strategia Ewolucyjna &  \\
  \hline
  11. & Programowanie Genetyczne &  \\
  \hline
  12. & Metody testowania i porównywania metod heurystycznych &  \\
  \hline
\end{longtable}
