...
\endhead
  \hline
  1. Wprowadzenie do podstaw obsługi Blendera. & & \\
  \hline
  2. Modelowanie w trybie obiektowym. & & \\
  \hline
  3. Modyfikatory. & & \\
  \hline
  4. Modelowanie w trybie edycji. & & \\
  \hline
  5. Modelowanie high-poly w trybie rzeźbienia. & & \\
  \hline
  6. Oświetlenie. & & \\
  \hline
  7. Materiały. & & \\
  \hline
  8. Tekstury proceduralne. & & \\
  \hline
  9. Mapowanie tekstur i przestrzenie współrzędnych. & & \\
  \hline
  10. Tekstury bitmapowe. & & \\
  \hline
  11. Wypalanie tekstur. & & \\
  \hline
  12. Optymalizacja sceny 3D i rendering. & & \\
  \hline
  13. Komponowanie (compositing). & & \\
  \hline
\end{longtable}
