...
\vspace{4pt}
\noindent\textbf{Zadania do samodzielnej realizacji:} Projektowanie i wytwarzanie gry w Unreal Engine; programowanie mechanik rozgrywki; praca w grupie projektowej; przygotowanie prezentacji projektu.
...
\textit{The aim of this course is to immerse students in the game creation cycle, from conceptual design to quality control, and to instill a deep understanding of industry practices, tools (such as Unreal Engine), and key processes necessary for a successful career in the games industry.}
...
\endhead
  \hline
  1. & Wprowadzenie do branży tworzenia gier. Prezentowanie historii gier z przykładami unikalnych i nieoczekiwanych ciekawych faktów na temat gier. &  \\
  \hline
  2. & Dyskusja na temat branży gier, osobistych doświadczeń uczniów z grami, wpływu gier na życie i tego, czego można się spodziewać pracując w tej branży. &  \\
  \hline
  3. & Wprowadzenie do projektowania gier. Dlaczego istnieje i jak to rozumieć. &  \\
  \hline
  4. & Projektowanie małej gry przy użyciu wyłącznie pióra i papieru. Granie i ulepszanie swoich gier. &  \\
  \hline
  5. & Projektowanie puzzli, jako głównego interaktywnego elementu zabawy. Jak łamigłówki angażują graczy. &  \\
  \hline
  6. & Projektowanie układanki przy użyciu dostarczonych ograniczeń i testowanie pojawiających się mechanik gry w małych grupach. &  \\
  \hline
  7. & Wprowadzenie do Unreal Engine. Przegląd układu i funkcji UE 5. &  \\
  \hline
  8. & Wykonanie pierwszego planu UE mechaniki gry z wykorzystaniem elementów interaktywnych. &  \\
  \hline
  9. & Podstawy silnika Unreal Engine. Ciąg dalszy przedstawiania silnika studentom. Wyjaśnienie rozwoju opartego na planach za pomocą interaktywnych przykładów. &  \\
  \hline
  10. & Studenci doskonalą i rozwijają pierwszy projekt stworzony podczas poprzedniego ćwiczenia, wykorzystując nową wiedzę zdobytą na wykładzie. &  \\
  \hline
  11. & Podstawowe zasady projektowania poziomu podstawowego i Asset Pipeline w UE5. &  \\
  \hline
  12. & Uczniowie korzystają z dostarczonych zasobów i niestandardowych materiałów, aby konfigurować i wykorzystywać własne projekty oraz projektować układ poziomów. &  \\
  \hline
  13. & Dokumentacja gry i dlaczego jest to ważne. &  \\
  \hline
  14. & Napisanie krótkiego opisu gry na podanym przykładzie. &  \\
  \hline
  15. & GDD. Przegląd i ocena GDD znanych gier. &  \\
  \hline
  16. & Pisanie GDD. Uczniowie korzystają z dostarczonego przykładu GDD i pracują w grupach, aby stworzyć własne dokumenty. &  \\
  \hline
  17. & Praca w zespole i zarządzanie projektem gry. &  \\
  \hline
  18. & Omówienie ról zespołowych i zarządzania sytuacją, kontynuacja pracy w zespołach, nad grami. &  \\
  \hline
  19. & Wprowadzenie do animacji w UE5. Rzuć okiem na możliwe potoki animacji i narzędzia dostępne w Unreal Engine. &  \\
  \hline
  20. & Implementacja podstawowych animacji w UE z wykorzystaniem dostarczonych materiałów i przykładów. &  \\
  \hline
  21. & Zrozumienie wpływu projektowania dźwięku w grach i sposobu implementacji dźwięków w UE5. &  \\
  \hline
  22. & Implementacja podstawowych dźwięków w UE z wykorzystaniem dostarczonych materiałów i przykładów. &  \\
  \hline
  23. & Zapewnienie jakości gier. Jak zespoły zapewniają jakość i dbałość o szczegóły. &  \\
  \hline
  24. & Testowanie dostarczonej przykładowej gry i przygotowanie raportu o błędzie. &  \\
  \hline
  25. & Praktyki HR w tworzeniu gier. Oczekiwania firm zajmujących się tworzeniem gier i czego szukają u potencjalnych kandydatów. &  \\
  \hline
  26. & Napisanie osobistego CV na podanym przykładzie. &  \\
  \hline
  27. & Zarządzanie zasobami studia gier. Ukryte koszty i dlaczego tak trudno osiągnąć równowagę pomiędzy zyskami a zabawą. &  \\
  \hline
  28. & Praca w grupach w celu przygotowania analizy rynkowej dostarczonej gry, przedstawienia planu ulepszeń z prośbą o dodatkowe inwestycje, analizy konkurencji i oceny innych grup uczniów. &  \\
  \hline
  29. & Pełne podsumowanie kursu. Powracanie do poprzednich lekcji, odświeżanie wiedzy i podkreślanie najważniejszych aspektów. &  \\
  \hline
  30. & Omawianie projektów gier zespołowych, ulepszanie i dopracowywanie projektów. &  \\
  \hline
\end{longtable}
