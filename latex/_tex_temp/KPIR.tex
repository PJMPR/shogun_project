...
\vspace{4pt}
\noindent\textbf{Zadania do samodzielnej realizacji:} Konfiguracja protokołów IoT (MQTT, CoAP, HTTP) w środowisku symulacyjnym; realizacja mikroprojektów; przygotowanie do egzaminu pisemnego.
...
\textit{The main objective of the course is to present the structure and operation of Internet of Things systems, in particular the methods and means of communication, including protocols that enable information exchange between sensors, actuators, and controllers. A characteristic feature of IoT systems is the use of low-power devices and operation in conditions requiring secure transmission and data processing.}
...
\endhead
  \hline
  1. & Wprowadzenie i sprawy organizacyjne. Wprowadzenie do zajęć projektowych i laboratoryjnych. &  \\
  \hline
  2. & System wbudowany a system IoT.Analiza dedykowane systemu IoT w  CISCO PacketTracer. &  \\
  \hline
  3. & Urządzenia i układy IoT. &  \\
  \hline
  4. & Projekt prostego systemu IoT w CISCO Packet Tracer. &  \\
  \hline
  5. & Architektura systemów IoT. &  \\
  \hline
  6. & Projekt systemu IoT z wykorzystaniem wybranego mikrokontrolera lub komputera jednoukładowego. &  \\
  \hline
  7. & Typy protokołów IoT. &  \\
  \hline
  8. & Konfiguracja i oprogramowanie systemu IoT. &  \\
  \hline
  9. & Zaawansowany protokół kolejkowania wiadomości. &  \\
  \hline
  10. & Walidacja i testowanie systemy IoT. &  \\
  \hline
  11. & Standardy komunikacyjne dla IoT. &  \\
  \hline
  12. & Wdrożenie i prezentacja systemu IoT. &  \\
  \hline
\end{longtable}
